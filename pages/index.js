            ...
            <div className="bg-img min-h-screen grid">
                <div className="flex flex-col items-center justify-center">
                    ...
                    <form className="flex flex-col items-center justify-center space-y-4 my-8">
                        <input
                            className="border-none outline-none text-xl md:text-2xl sm:px-2 py-2 md:px-24 md:py-4 text-center placeholder:font-poppy bg-off-brand placeholder:text-dense placeholder:opacity-70 font-poppy hover:placeholder:-translate-y-20 placeholder:duration-[0.5s]"
